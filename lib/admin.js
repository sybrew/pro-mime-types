...
document.addEventListener( 'DOMContentLoaded', () => {
	...
	async function createTooltip( event ) {
		...
		event.target.innerHTML +=
			`<div class=pmt-tooltip><span class=pmt-tooltip-text-wrap>
				<span class=pmt-tooltip-text>${event.target.dataset.pmtTooltip}</span>
			<div class=pmt-tooltip-arrow></div></div>`;
